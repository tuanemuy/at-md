...
- [ ] エンティティの実装（User, GitHubConnection）
- [ ] 値オブジェクトの実装（Profile, Session）
- [ ] DTOの実装（GitHubInstallation）
- [ ] エラー型の実装（AccountError）
- [ ] バリデーション関数の実装
- [ ] リポジトリインターフェースの定義
- [ ] アダプターインターフェースの定義
- [ ] ユースケースインターフェースの定義
...
- [ ] エンティティの実装（Note, Book, Tag）
- [ ] 値オブジェクトの実装（BookDetails, SyncStatus）
- [ ] エラー型の実装（NoteError）
- [ ] バリデーション関数の実装
- [ ] リポジトリインターフェースの定義
- [ ] アダプターインターフェースの定義
...
- [ ] エンティティの実装（Post, Engagement）
- [ ] 値オブジェクトの実装（PostSettings）
- [ ] エラー型の実装（PostError）
- [ ] バリデーション関数の実装
- [ ] リポジトリインターフェースの定義
- [ ] アダプターインターフェースの定義
...
- [ ] DIコンテナの設定（`./infrastructure-layer.md`を参考にコンストラクタインジェクションで実現する）
- [ ] 環境変数管理（dotenvとzodによる型安全な設定）
- [ ] HTTPクライアントの共通実装

### ステップ3.2 データベース基盤

- [ ] Drizzleのセットアップ（ユーザーが行う）
- [ ] マイグレーション管理の設定（ユーザーが行う）
- [ ] アカウント管理コンテキストのスキーマ定義
- [ ] ノート管理コンテキストのスキーマ定義
- [ ] 投稿管理コンテキストのスキーマ定義
